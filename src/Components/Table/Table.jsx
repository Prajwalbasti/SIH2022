...
function Table({  data }) {
    ...
    var headers = ["Amount", "Appointment Date", "Customer", "Due Date", "Invoice Date", "Invoice Number", "Item Description 1", "Item Description 2", "Item Quantity", "Last Name", "Location", "Provider Id", "Provider Name", "Rate", "Service Date", "State", "Taxable", "Terms" ]
